...
write.csv(params_species, file = "data/params_species.csv",row.names = F)
...
title(main="Variables latentes", outer=T)
## probit_theta
par (mfrow=c(1,2))
...
\begin{figure}[H]
 \caption[Représentation spatiale des variables latentes estimés pour chaque site]{Représentation spatiale des variables latentes estimés pour chaque site}
  \label{fig:condSimApp}
  \centering
