...
write.csv(cv_alphas, file = "~/Documents/projet_BioSceneMada/Report/data/cv_alphas.csv", row.names = F)
...
save(ok_alpha, ok_W1, ok_W2, file="~/Documents/projet_BioSceneMada/Report/data/OK.RData")
```
...
load("~/Documents/projet_BioSceneMada/Report/data/OK.RData")
...
## Wlambda_1
Wlambda_1 <- ok_W1$W1  * lambda_1[1] + ok_W2$W2  * lambda_2[1]
## probit_theta_1
...
save(probit_theta,file="~/Documents/projet_BioSceneMada/Report/data/OK_probit_theta1.RData")
...
save(probit_theta,file="~/Documents/projet_BioSceneMada/Report/data/OK_probit_theta2.RData")
...
load("~/Documents/projet_BioSceneMada/Report/data/OK_probit_theta1.RData")
theta <- probit_theta
remove(probit_theta)
...
save(theta,file="~/Documents/projet_BioSceneMada/Report/data/OK_theta1.RData")
par(mfrow=c(1,2),oma=c(1, 0, 1.4,1))
plot(theta[[c(1,175)]],cex.main=0.7)
title(main="Probabilités de présence interpolées",outer=T,cex.main=0.9)
# Second half
remove(theta)
load("~/Documents/projet_BioSceneMada/Report/data/OK_probit_theta2.RData")
theta <- probit_theta
remove(probit_theta)
values(theta[[1]]) <- pnorm(as.vector(values(theta[[1]])))
...
save(theta,file="~/Documents/projet_BioSceneMada/Report/data/OK_theta2.RData")
remove(theta)
```
...
load("~/Documents/projet_BioSceneMada/Report/data/OK_theta1.RData")
species_richness <- sum(theta)
remove(theta)
load("~/Documents/projet_BioSceneMada/Report/data/OK_theta2.RData")
species_richness <- species_richness + sum(theta)
remove(theta)
save(species_richness,file="~/Documents/projet_BioSceneMada/Report/data/specific_richness.RData")
plot(species_richness, main = "Richesse spécifique interpolée")
```

```{r specific_richness_forest}
load(file="~/Documents/projet_BioSceneMada/Report/data/specific_richness.RData")
load(file="~/Documents/projet_BioSceneMada/Report/data/forest_res.RData")

# forest <- raster("~/Documents/projet_BioSceneMada/Report/data/for2000.tif")
# # unit m to km
